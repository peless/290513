...
public class DBservices
{
    ...
    public void insertNewMessage(string text_message)
    {
        ...
        insertSTR = "insert into Message values ((select max(Number)from Message)+1 ,'" + text_message + "')";
    ...
    public static string GetMail(string ID)
    {
        try
        {
            SqlConnection con = connect("igroup31_test1ConnectionString");

            string ReturnMailSTR;
            SqlCommand cmd1 = new SqlCommand();
            object ReturnMail;
            

            cmd1.CommandText = "select Email from Worker  where W_ID='" + ID + "'";
            cmd1.CommandType = CommandType.Text;
            cmd1.Connection = con;



            ReturnMail = cmd1.ExecuteScalar();

            ReturnMailSTR = ReturnMail.ToString();

            return ReturnMailSTR;
    ...
    public static List<string> GetWorkerDetails(string SentW_ID)
    {
        ...
        try
        {
            ...
            String selectSTR = " select * from Worker Where W_ID='"+SentW_ID+"'";
