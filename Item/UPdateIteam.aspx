<%@ Page Title="" Language="C#" MasterPageFile="~/neframor.master" AutoEventWireup="true" CodeFile="UPdateIteam.aspx.cs" Inherits="Item_UPdateIteam" %>
...
<table dir="rtl"  style="width:100% ; margin-left:-10px">
    ...
    <tr>
        <td></td>
        <td><asp:Button ID="AddButton" runat="server" Text="הוסף"  /></td>
    </tr>
</table>
</asp:Content>
