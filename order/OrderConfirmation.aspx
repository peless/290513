...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <center><div id="divOrder"  runat="server" style="width:80%">
      </div></center>

    
     <table style="float:right; height: 105px; margin-top: 22px; margin-right: 100px;"><tr><td>
     <asp:Button ID="Approval" class="BTN" runat="server" Text="אישור הזמנה" onclick="Approval_Click"   />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </td>
    <td>
    <asp:Button ID="Button1" runat="server"  class="BTN" Text="סימון כל ההזמנה" onclick="ChekAll_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </td>
    <td>
    ...
    <asp:Button ID="Barcode" runat="server"  class="BTN" style="width: 157px"
             Text="קריאת ברקוד" onclick="Barcode_Click" 
             />
